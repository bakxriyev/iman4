...
const RESULT_TEXT = {
  ...
  paragraphs: [
    "Siz o‘zingizni qadrlashni unutib qo‘ygansiz.  Sizning qalbingiz mehrga juda muhtoj. Siz charchagansiz va ruhiy sokinlik izlayapsiz. Ruhiy holat munosabatlarga juda ta’sir qilishi mumkinligini bilasiz. Sizga ayni damda ruhiy yengillik, hamda sizni tushunadigan inson kerak.  Sizning qalbingiz dam olishni xohlaydi.    Balki qalbingiz yana duo bilan ochilar…",
    "🤍 Duo — faqat so‘rash emas, ichki shifo hamdir.    Sizning javobingiz aslida qalbingiz eng ko‘p nimaga muhtojligini ko‘rsatadi…",
  ],
