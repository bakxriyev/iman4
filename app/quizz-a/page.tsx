...
const RESULT_TEXT = {
  ...
  paragraphs: [
    "Sizda ichki xavotir va yaqinlaringizga bog‘lanish qo‘rquvi juda kuchli. Shu bois sevgi uchun doim kurashishga odatlangansiz. Chunki bog’lanib qolgan insonlaringizni yo’qotishdan qo’rqasiz.",
    "Ich - ichingizdan judayam yumshoq va nozik insonsiz. Bazi baizda hali ham o‘zingizning kuchingizni to‘liq anglamagandek his qilasiz. Sevgan insoningiz sevgisini uning  “e’tibor” ida deb bilasiz. E’tiborsizlik qilinganda sevilmagandek his qilasiz. O’zingiz juda fidoyi  va  doim yaqinlaringizga  mehrni ko‘p berasiz. Shuning uchun ham mehrga mehr javobi qaytmaganida xafa bo’lib qolasiz. Qalbingiz Allohga yaqin, undan qo’rqasiz, bazida esa yomon banda bo’lmadimmikin degan qo’rquvda bo’lasiz.",
  ],
