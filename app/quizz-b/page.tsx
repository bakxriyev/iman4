...
const RESULT_TEXT = {
  ...
  paragraphs: [
  "Sizning javoblaringiz  aslida qalbingiz eng ko‘p nimaga muhtojligini ko‘rsatadi. Siz mehr va yaqinlikka juda chanqoqsiz.    Ichingizdagi og‘riqni yutib yurishingiz mumkin. Siz uchun ishonch hammasidan ham muhim. O‘zini sevgan ayol boshqalar tomonidan ham qadrlanadi deb hisoblaysiz.     Yuragingiz yaqin insonni doim qidirasiz. Ichingizda qabdaydir bo’shliq bor va uni nimaligini bilmaysiz. Ko’p mehr berasiz va O‘zingizni unutib qo‘yasiz. Yaqinlaringiz tomonidan qilinadigan sovuq munosabar  sizni ichdan sindiradi. Siz qiyin vaziyatlarda duo qilishni xoxlaysiz. Sizning javobingiz aslida qalbingiz eng ko‘p nimaga muhtojligini ko‘rsatadi…" ],
